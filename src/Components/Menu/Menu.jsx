...
const Menu = () => {
  ...
  return (
    <Container
      className="w-full h-full px-3 py-20 md:py-32 sm:px-12 md:px-8 lg:px-16"
      id="menu"
    >
      <Row className="relative">
        ...
        <p className="py-4 text-lg break-all sm:text-center">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis ad
          ratione, nihil <br className=" hidden sm:block" /> deserunt ullam illo
          nemo iste repudiandae, nisi corporis rem et. Cupiditate quo iure
          voluptatum <br className=" hidden sm:block" /> voluptatem expedita
          repudiandae quod!
        </p>
        <Col className="flex flex-wrap items-center justify-center gap-2">
          ...
          >
            <img src={shawarmasvg} alt="svg" className="w-8 h-8" />
            <h6>Shawarma</h6>
          </Button>
          <Button
        ...
        <Col>
          <img
            src={vegetable1}
            className="absolute object-contain w-16 h-14 sm:h-24 sm:w-24 sm:left-10 top-2 lg:top-10"
            alt="vegetable"
          />
          <img
            src={vegetable2}
            className="absolute right-0 object-contain w-16 h-14 sm:h-24 sm:w-24 sm:right-10 top-2 lg:top-10"
            alt="vegetable"
          />
          <img
            src={vegetable3}
            className="absolute object-contain w-16 -left-8 h-14 sm:h-32 sm:w-32 sm:-left-24 top-32 lg:top-48"
            alt="vegetable"
          />
          <img
            src={vegetable4}
            className="absolute object-contain w-16 -right-6 h-14 sm:h-24 sm:w-24 sm:-right-12 top-32 lg:top-48"
            alt="vegetable"
          />
          <img
            src={vegetable5}
            className="absolute object-contain w-16 h-14 sm:h-32 sm:w-32 -bottom-6 sm:-left-24"
            alt="vegetable"
          />
          <img
            src={vegetable6}
            className="absolute right-0 w-16 h-14 sm:h-24 sm:w-24 -bottom-4 object-6contain sm:-right-10"
            alt="vegetable"
          />
        </Col>
      </Row>
