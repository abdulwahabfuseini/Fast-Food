      ...
      <Row className="flex flex-col lg:gap-14 lg:flex-row">
        <Col  className="w-full lg:w-1/2" data-aos="fade-right">
          ...
          <h4 className="flex flex-wrap items-center gap-2 text-xl capitalize sm:text-4xl">
            ...
            <span>
              <img
                src="./images/SVG/deliveryMotor1.png"
                alt=""
                className="w-16 h-14"
              />
            </span>
          ...
          <Col className="flex items-center gap-2 py-10 lg:py-20 sm:gap-10" data-aos="fade-up">
            <img
              src="./images/SVG/chefsvg.png"
              className="w-14 h-14"
              alt="avatar"
            />
        ...
        <Col className="grid w-full lg:w-1/2 place-items-center"  data-aos="fade-left">
          <Col className="rounded-full shadow-2xl w-[340px] h-[340px]  md:h-[600px] md:w-[600px] sm:w-[450px] sm:h-[450px] grid place-items-center" >
            <img className="delivery w-[380px] h-[380px] md:w-[700px] md:h-[600px] object-cover" src="../images/SVG/DeliveryMan.png" alt="delivery"/>
          </Col>
        </Col>
      </Row>
    </Container>
